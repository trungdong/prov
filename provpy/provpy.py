...
class Account(PROVGraph):
    
    def __init__(self,id,parentaccount=None):
        PROVGraph.__init__(self)
        self.identifier = id
    ...
    def to_JSON(self):
        ...
        self._provcontainer['account'].update({self.identifier:innergraph})
        return self._provcontainer
    

class PROVLiteral(Record):
