...
All three read and write out of the box, with no extra needed. Every other capability sits
behind an optional extra. Using one without its extra raises an error that names the extra
to install.
