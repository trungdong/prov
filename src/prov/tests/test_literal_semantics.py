...
def test_decimal_literals_compare_in_value_space() -> None:
...
def test_langtag_case_is_preserved_in_output() -> None:
...
def test_rdf_plain_string_emitted_without_xsd_string() -> None:
